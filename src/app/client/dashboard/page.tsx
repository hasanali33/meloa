...
export default function ClientDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 p-4 md:p-10">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-blue-800">👋 Welcome back, {client.name?.split(' ')[0] || 'Friend'}!</h1>
        <button
